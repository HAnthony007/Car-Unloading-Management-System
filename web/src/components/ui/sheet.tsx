        ...
        <SheetPortal>
            ...
            <SheetPrimitive.Content
                ...
                className={cn(
                    ...
                    side === "right" &&
                        size === "wide" &&
                        "data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-y-0 right-0 h-full w-5/6 border-l",
                    side === "left" &&
                        size === "default" &&
                    ...
                    side === "left" &&
                        size === "wide" &&
                        "data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left inset-y-0 left-0 h-full w-5/6 border-r",
                    side === "top" &&
