...
export const FollowupPagination = ({
    ...
    if (totalPages <= 1) {
        return (
            <div className="flex flex-col items-start justify-between gap-3 rounded-xl border bg-gradient-to-br from-white to-muted/30 p-4 md:flex-row md:items-center">
                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        <SelectTrigger className="h-9 w-24">
                            <SelectValue aria-label={`Taille ${pageSize}`} />
                        </SelectTrigger>
                        <SelectContent>
    ...
    return (
        <div className="flex flex-col items-start justify-between gap-4 rounded-xl border bg-gradient-to-br from-white to-muted/30 p-4 md:flex-row md:items-center">
