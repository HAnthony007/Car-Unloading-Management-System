...
class StoreDischargePhotoRequest extends FormRequest
{
    ...
    {
        return [
            'file' => ['required', 'file', 'mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml', 'max:10240'],
    ...
    public function messages(): array
    {
        return [
            ...
            'file.max' => 'Image is too large (max 10MB).',
        ];
    }
